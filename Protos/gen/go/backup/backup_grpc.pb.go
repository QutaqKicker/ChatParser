...
const (
	Backup_ExportToDir_FullMethodName = "/backup.Backup/ExportToDir"
)
...
func (c *backupClient) ExportToDir(ctx context.Context, in *ExportToDirRequest, opts ...grpc.CallOption) (*ExportToDirResponse, error) {
	...
	err := c.cc.Invoke(ctx, Backup_ExportToDir_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Backup_ExportToDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backup_ExportToDir_FullMethodName,
	}
